...
public class BookHotelSteps extends BaseClass {
    ...
    public void EnteringTheDetailsInBookHotelPage(String id) {
        ...
        assertTrue(bookhotelpage.getHotelNameValue(),entityHelper.getCustomerDataById(id).getHotelName(),"HotelName from Select Hotel is Validated");
        assertTrue(bookhotelpage.getLocationValue(),entityHelper.getCustomerDataById(id).getLocation(),"Location from Select Hotel is Validated");
        assertTrue(bookhotelpage.getRoomTypeValue(),entityHelper.getCustomerDataById(id).getRoomtype(),"RoomType from Select Hotel is Validated");
