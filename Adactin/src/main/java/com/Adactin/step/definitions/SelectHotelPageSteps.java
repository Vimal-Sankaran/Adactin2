...
public class SelectHotelPageSteps extends BaseClass {
  ...
  {
      String temp;
      assertTrue(selectHotelPage.getHotelName(),entityHelper.getCustomerDataById(id).getHotelName(),"HotelName from Select Hotel is Validated");
      assertTrue(selectHotelPage.getLocation(),entityHelper.getCustomerDataById(id).getLocation(),"Location from Select Hotel is Validated");
